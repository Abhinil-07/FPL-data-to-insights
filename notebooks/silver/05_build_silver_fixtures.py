...
fixtures_silver = fixtures_raw \
    ...
    .select(
        ...
        F.coalesce(F.col("finished_provisional").cast("boolean"), F.lit(False)).alias("finished_provisional"),
        F.coalesce(F.col("started").cast("boolean"), F.lit(False)).alias("started"),
